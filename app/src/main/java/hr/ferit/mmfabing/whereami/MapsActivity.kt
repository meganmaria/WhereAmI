package hr.ferit.mmfabing.whereami
...
import hr.ferit.mmfabing.whereami.databinding.ActivityMapsBinding
import java.io.File
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapsBinding.inflate(layoutInflater).also {
            it.picture.setOnClickListener {
        ...
        if (resultCode == Activity.RESULT_OK) {
            when (requestCode) {
                CAPTURE_PHOTO -> {
                    ...
                    binding = ActivityMapsBinding.inflate(layoutInflater).also {
                        it.pic.setImageBitmap(capturedBitmap)
                    }
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val latitude = 45.619056496030375
        val longitude = 17.944562167281575
        val zoomLevel = 15f
